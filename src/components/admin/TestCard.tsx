...
const TestCard: React.FC<{
  ...
  const isRecent = test.createdAt && Date.now() - new Date(test.createdAt).getTime() < 30_000;

  return (
    <div className={`bg-white border rounded-lg hover:shadow-sm transition-all duration-200 ${
