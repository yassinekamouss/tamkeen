        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6 overflow-x-auto py-4 scrollbar-hide">
            <button
              ...
              className={`flex-shrink-0 pb-1 text-xs font-mono uppercase tracking-wider transition-all duration-200 border-b-2 bg-transparent ${selectedCategory === "all"
            ...
            {categories.map((category) => (
              <button
                ...
                className={`flex-shrink-0 pb-1 text-xs font-mono uppercase tracking-wider whitespace-nowrap transition-all duration-200 border-b-2 bg-transparent ${selectedCategory === category[lang]
                    ? "border-[#F97316] text-[#1F2937] font-bold"
                    : "border-transparent text-[#1F2937]/60 hover:text-[#1F2937]"
                  }`}
              >
